const translations = {
  de: {
    ...
    hero: {
      title: "Professionelle Pflege mit Herz",
      subtitle: "Spezialisierte medizinische Versorgung und empathische Begleitung in Hannover und Umgebung",
    ...
    chat: {
      title: "AI Assistent",
      welcome: "Hallo! Ich bin Ihr AI-Assistent. Ich kann Ihnen Informationen über unsere Dienstleistungen geben und allgemeine Ratschläge zu Medikamenten erteilen. Wichtig: Ich stelle keine Diagnosen, sondern biete nur informative Unterstützung.",
  ...
  en: {
    ...
    hero: {
      title: "Professional Care with Heart",
      subtitle: "Specialized medical care and empathetic support in Hannover and surrounding areas",
      cta1: "Our Services",
      cta2: "Get in Touch"
    },
    services: {
  ...
  ru: {
    ...
    hero: {
      title: "Профессиональный уход с душой",
      subtitle: "Специализированная медицинская помощь и эмпатичное сопровождение в Ганновере и окрестностях",
      cta1: "Наши услуги",
      cta2: "Связаться"
    },
    services: {
    ...
    chat: {
      title: "AI Ассистент",
      welcome: "Привет! Я ваш AI-ассистент. Я могу предоставить информацию о наших услугах и общие советы по лекарствам. Важно: я не ставлю диагнозы, а только предоставляю информационную поддержку.",
  ...
  ua: {
    ...
    hero: {
      title: "Професійний догляд із серцем",
      subtitle: "Спеціалізована медична допомога та емпатійна підтримка в Ганновері та околицях",
      cta1: "Наші послуги",
      cta2: "Зв'язатися"
    },
    services: {
    ...
    chat: {
      title: "AI Помічник",
      welcome: "Привіт! Я ваш AI-помічник. Я можу надати інформацію про наші послуги та загальні поради щодо ліків. Важливо: я не ставлю діагнозів, лише надаю інформаційну підтримку.",
  ...
  ar: {
    ...
    hero: {
      title: "رعاية احترافية بقلب",
      subtitle: "رعاية طبية متخصصة ودعم عاطفي في هانوفر والمناطق المحيطة",
      cta1: "خدماتنا",
      cta2: "تواصل معنا"
    },
    services: {
